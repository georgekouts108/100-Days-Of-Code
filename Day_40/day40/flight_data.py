class FlightData:
    ...
    def __init__(self, price, origin, destination, departure_date, return_date, stops):
        self.price = price
        self.origin = origin
...
def find_cheapest_flight(data):
    ...
    cheapest_flight = FlightData(cheapest_price, origin, destination, departure_date, return_date, nr_stops)
