...
def add_new_post():
    ...
    return render_template("make-post.html", form=form, source='New Post')


# TODO: edit_post() to change an existing blog post
@app.route('/edit-post/<post_id>', methods=['GET', 'POST'])
def edit_post(post_id):
    target_post = db.get_or_404(BlogPost, post_id)
    edit_form = CreatePostForm(
        title=target_post.title,
        subtitle=target_post.subtitle,
        img_url=target_post.img_url,
    ...
    return render_template("make-post.html", form=edit_form, source='Edit Post')
